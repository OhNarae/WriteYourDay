...
<link rel="stylesheet" href="resources/css/grid.css" type="text/css"
	media="screen">
<script src="resources/resources/js/jquery-1.6.2.min.js"
	type="text/javascript"></script>
<script src="resources/resources/js/jquery.galleriffic.js"
	type="text/javascript"></script>
<script src="resources/resources/js/jquery.opacityrollover.js"
	type="text/javascript"></script>
<!--[if lt IE 7]>
		...
		<div class="row-2">
			<div class="main">
				<div class="container_12">
					<div class="grid_9">
						<h1>
							<a class="logo" href="index.html">Int<strong>e</strong>rior
							</a> <span>Design</span>
						</h1>
					</div>
					<div class="grid_3">
								...
								<div class="wrapper indent-bot">
									...
									<div id="thumbs" class="navigation">
										<ul class="thumbs noscript">
											<li><a class="thumb"
												href="resources/images/gallery-img1.jpg" title=""> <img
													src="resources/images/thumb-1.jpg" alt="" /><span></span>
											</a></li>
											<li><a class="thumb"
												href="resources/images/gallery-img2.jpg" title=""> <img
													src="resources/images/thumb-2.jpg" alt="" /> <span></span></a>
											</li>
											<li><a class="thumb"
												href="resources/images/gallery-img3.jpg" title=""> <img
													src="resources/images/thumb-3.jpg" alt="" /> <span></span></a>
											</li>
											<li><a class="thumb"
												href="resources/images/gallery-img4.jpg" title=""> <img
													src="resources/images/thumb-4.jpg" alt="" /> <span></span></a>
											</li>
											<li><a class="thumb"
												href="resources/images/gallery-img5.jpg" title=""> <img
													src="resources/images/thumb-5.jpg" alt="" /> <span></span></a>
											</li>
											<li><a class="thumb"
												href="resources/images/gallery-img6.jpg" title=""> <img
													src="resources/images/thumb-6.jpg" alt="" /> <span></span></a>
											</li>
										</ul>
									</div>
								</div>
